...
const List = ({
    reqList, listLoading, pageNumber, pageSize, total, dispatch,
}) => {
    const init = () => {
...
List.propTypes = {
    reqList: PropTypes.array.isRequired,
...
const mapStateToProps = ({[prefix]: {reqList, listLoading, pageNumber, pageSize, total}}) => {
    return {reqList, listLoading, pageNumber, pageSize, total};
};
