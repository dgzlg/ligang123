...
const List = ({
    resList, listLoading, pageNumber, pageSize, total, dispatch,
}) => {
    const init = () => {
...
const mapStateToProps = ({[prefix]: {resList, listLoading, pageNumber, pageSize, total}}) => {
    return {resList, listLoading, pageNumber, pageSize, total};
};
